    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-surface p-4 relative app-entrance">
        ...
        <div className="w-full max-w-sm bg-white rounded-xl shadow-2xl p-8 z-10">
          ...
          <p className="text-xs text-text-secondary text-center font-medium">Enterprise Coordination Portal</p>
          <p className="text-[10px] text-indigo-600 text-center mb-8 font-extrabold tracking-[0.2em] uppercase">On Branch EXP</p>
