...
import {
  auth, onAuthStateChanged, signOut, setPersistence, inMemoryPersistence,
  GoogleAuthProvider, signInWithPopup, db, collection, query, where, getDocs, setDoc, doc, serverTimestamp
} from './firebase.js';
  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#f0f2f5] p-4 relative app-entrance">
        <div className="absolute top-0 left-0 w-full h-[40vh] bg-[#00a884] z-0"></div>
        <div className="w-full max-w-sm bg-white rounded-xl shadow-[0_17px_50px_0_rgba(11,20,26,.19),0_12px_15px_0_rgba(11,20,26,.24)] p-8 z-10">
