      ...
      <div className="bg-white w-full max-w-sm rounded-3xl shadow-2xl animate-in zoom-in-95 overflow-hidden max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-6">
          <div className="flex flex-col items-center gap-4">
            <div className="w-24 h-24 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden relative cursor-pointer group shadow-inner" onClick={() => profilePicInputRef.current?.click()}>
          ...
          <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200">
            ...
            <div className="space-y-2">
              ...
              <label className="flex flex-col gap-1 cursor-pointer p-2 mt-1 hover:bg-white rounded-lg transition-colors">
                ...
                <select value={toolPreferences.soundProfile || 'classic'} onChange={(e) => setToolPreferences(prev => ({...prev, soundProfile: e.target.value}))} className="w-full p-2 border border-slate-200 rounded text-[13px] bg-slate-50 outline-none focus:ring-2 focus:ring-[#008069]/20 text-slate-700">
