                ...
                for (const document of snap.docs) {
                    ...
                    if (scheduledMs <= now.getTime()) {
                        const payload = {
                            ...
                            isPrivateForward: data.isPrivateForward || false,
                            groupName: data.groupName || activeGroup?.name || ''
                        };
                    ...
                    <div className="flex h-full w-full relative">
                        ...
                        {!featureFlags.chat ? (
                            ...
                            <div className="hidden md:flex flex-1 flex-col items-center justify-center bg-slate-100 text-center p-8 relative">
                                ...
                                {(effectiveCurrentUserData?.isAdmin || effectiveIsVipAdmin || currentUserData?.canCreateGroups) && (
