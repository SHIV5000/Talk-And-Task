    ...
    if (this.state.hasError) {
      return (
        <div className="p-8 bg-red-50 text-red-800 h-screen w-full flex flex-col items-center justify-center overflow-auto z-50 absolute inset-0">
          ...
          <button className="mt-6 bg-red-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:scale-105 transition-transform" onClick={() => window.location.reload()}>Reload Application</button>
        </div>
      );
    }
